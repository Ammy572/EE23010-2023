...
Question 1.4.5- Draw the circle with centre at O and radius 
\begin{align}
${R} = OA$
\end{align}
\solution Given, 
...
Radius: 
\begin{align}
\vec{R} &= \sqrt{{(\vec{A}-\vec{O})}^{\top}{(\vec{A}- \vec{O})}}\\
\vec{A} - \vec{O} &= \myvec{(1)-(0)\\(-1)-0}\\
\implies \vec{R} &= \sqrt{\myvec{1 & -1}\myvec{1 \\ -1}}\\
&= 1.41
\end{align} 
$\therefore {R} = 1.41$\\
